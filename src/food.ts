import { FoodCategory, FoodName } from './types';

export const GARLIC_CLOVE = {
    name: FoodName.GARLIC_CLOVE,
    category: FoodCategory.PRODUCE,
};
export const CARROT = { name: FoodName.CARROT, category: FoodCategory.PRODUCE };
export const RED_ONION = {
    name: FoodName.RED_ONION,
    category: FoodCategory.PRODUCE,
};
...
export const PERSIAN_CUCUMBER = {
    name: FoodName.PERSIAN_CUCUMBER,
    category: FoodCategory.PRODUCE,
};
export const CILANTRO = {
    name: FoodName.CILANTRO,
    category: FoodCategory.PRODUCE,
};
export const LEMON = { name: FoodName.LEMON, category: FoodCategory.PRODUCE };
export const CHILI_PEPPER_FRESH = {
...
export const BUTTON_MUSHROOMS = {
    name: FoodName.BUTTON_MUSHROOMS,
    category: FoodCategory.PRODUCE,
};
...
export const YELLOW_ONION = {
    name: FoodName.YELLOW_ONION,
    category: FoodCategory.PRODUCE,
};
export const JALAPENO = {
    name: FoodName.JALAPENO,
    category: FoodCategory.PRODUCE,
};
export const ZUCCHINI = {
    name: FoodName.ZUCCHINI,
    category: FoodCategory.PRODUCE,
};
...
export const ROMA_TOMATOES = {
    name: FoodName.ROMA_TOMATOES,
    category: FoodCategory.PRODUCE,
};
